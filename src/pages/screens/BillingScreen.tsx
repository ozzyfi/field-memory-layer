  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h1 className="font-serif text-5xl text-foreground mt-4">{t("bill.title")}</h1>
        <p className="text-sm text-muted-foreground mt-2">{t("bill.subtitle")}</p>
      </div>
      <section className="rounded-lg border border-border bg-card p-8">
        <div className="text-xs uppercase tracking-widest text-muted-foreground">{t("bill.balance")}</div>
